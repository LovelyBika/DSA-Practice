...
{ 
  ...
  case 1 :  printf("the elements of your array\n");
             traversal(arr,size);
            break;
  case 2  : printf("Enter the index where you want to insert\n");
            int index;
            scanf("%d",&index);
           printf("enter the element you want to insert\n");     
             ...
             break;
  case 3 : printf("enter the index where u want to perform deletion\n");
            scanf("%d",&index);
            indDeletion(arr,index,size);
            traversal(arr,size-1);
            break;
  
  case 4  : linearsearch(arr,size);
            break;
  case 5:   binearySearch(arr,size);
            break;         
  case 6 : exit(0);
            break;         
  default:  printf("you out of given choices");
      break;
  }
